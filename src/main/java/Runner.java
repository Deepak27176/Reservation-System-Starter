...
public class Runner {
    ...
    static List<Aircraft> aircrafts = Arrays.asList(
           ...
           new PassengerPlaneAdapter( new PassengerPlane("Embraer 190")),
           new PassengerPlaneAdapter(new PassengerPlane("Antonov AN2")),
           new HelicopterAdapter( new Helicopter("H1")),
           new PassengerDroneAdapter( new PassengerDrone("HypaHype"))
    );
