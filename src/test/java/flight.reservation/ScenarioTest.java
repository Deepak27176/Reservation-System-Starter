...
public class ScenarioTest {
    ...
    class CustomerTwoPassengersPaypalPayment {
        ...
        class NoHelicoptersInFrankfurt {
            ...
            void thenFlightNotAvailable() {
                assertThrows(IllegalArgumentException.class, () -> flightFactory.createFlight(1, startAirport, destinationAirport, helicopterFactory.createAircraft("H1")));
            }
        ...
        class FlightIsPossible {
            ...
            public void initFlights() {
                ...
                flight = flightFactory.createFlight(1, startAirport, destinationAirport,helicopterFactory.createAircraft("H1") );
    ...
    class CustomerOnePassengerCreditCardPayment {
        ...
        public void init() {
            ...
            destinationAirport = new Airport("Frankfurt Airport", "FRA", "Frankfurt, Hesse");
            flight = flightFactory.createFlight(1, startAirport, destinationAirport,passengerPlaneFactory.createAircraft("A380") );
            Date departure = TestUtil.addDays(Date.from(Instant.now()), 3);
            schedule.scheduleFlight(flight, departure);
            // customer
            customer = new Customer("Max Mustermann", "amanda@ya.com");
