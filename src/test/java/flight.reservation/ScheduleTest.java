...
import flight.reservation.plane.HelicopterAdapter;
import flight.reservation.plane.PassengerDrone;
import flight.reservation.plane.PassengerDroneAdapter;
import flight.reservation.plane.PassengerPlane;
import flight.reservation.plane.PassengerPlaneAdapter;
...
public class ScheduleTest {
    ...
    class GivenAnEmptySchedule {
        ...
        void thenScheduleShouldYieldEmpty() {
            schedule.removeFlight(new Flight(1, new Airport("a", "a", "a"), new Airport("b", "b", "b"), new PassengerPlaneAdapter( new PassengerPlane("A380"))));
            assertEquals(0, schedule.getScheduledFlights().size());
        }
        ...
        class WhenAFlightIsScheduled {
            ...
            void scheduleOneFlight() {
                ...
                flight = new Flight(1, startAirport, destAirport, new PassengerPlaneAdapter(aircraft));
    ...
    class GivenAnExistingSchedule {
        ...
        List<Flight> flights = Arrays.asList(
                new Flight(1, airports.get(0), airports.get(1), new PassengerPlaneAdapter( new PassengerPlane("A350"))),
                new Flight(2, airports.get(1), airports.get(2), new PassengerPlaneAdapter( new PassengerPlane("A380"))),
                new Flight(3, airports.get(2), airports.get(4),new PassengerPlaneAdapter( new PassengerPlane("Embraer 190"))),
                new Flight(4, airports.get(3), airports.get(2),new PassengerPlaneAdapter( new PassengerPlane("Antonov AN2"))),
                new Flight(5, airports.get(4), airports.get(2),new HelicopterAdapter(new Helicopter("H1"))),
                new Flight(6, airports.get(5), airports.get(7), new PassengerDroneAdapter(new PassengerDrone("HypaHype")))
        );
